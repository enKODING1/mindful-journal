...
const mockJournals: Content[] = [
    {
        ...
        content: { iv: 'mock-iv', data: 'mock-data' },
        title: { iv: 'mock-iv', data: 'mock-title-data' },
        decryptedTitle: '특별한 하루',
        decryptedContent:
    ...
    },
    {
        ...
        content: { iv: 'mock-iv', data: 'mock-data' },
        title: { iv: 'mock-iv', data: 'mock-title-data' },
        decryptedTitle: '독서로 채운 여유로운 일요일',
        decryptedContent:
